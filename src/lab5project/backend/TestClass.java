...
public class TestClass {
    ...
    public TestClass() {
        EmployeeUserDatabase empDatabase = new EmployeeUserDatabase("C:\\Users\\ADMIN\\Documents\\NetBeansProjects\\Lab5Project\\employees.txt");
        ProductDatabase productDatabase = new ProductDatabase("C:\\Users\\ADMIN\\Documents\\NetBeansProjects\\Lab5Project\\products.txt");
        CustomerProductDatabase customerProductDatabase = new CustomerProductDatabase("C:\\Users\\ADMIN\\Documents\\NetBeansProjects\\Lab5Project\\customerproducts.txt");
        admin = new AdminRole(empDatabase);
        employee = new EmployeeRole(productDatabase, customerProductDatabase);
    }

    public void testAdminRole() {

        EmployeeUser[] employees = (EmployeeUser[]) admin.getListOfEmployees();
        for (EmployeeUser emp : employees) {
            admin.removeEmployee(emp.getSearchKey());
        }
        admin.logout();

        employees = (EmployeeUser[]) admin.getListOfEmployees();
